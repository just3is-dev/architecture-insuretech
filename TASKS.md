...
Вот диаграмма контейнеров приложения в модели C4 (см. [тут](./c4.png))
...
В draw.io установите библиотеки иконок Yandex Cloud для сервисов ([Yandex_Cloud_services_oct_23.xml](https://code.s3.yandex.net/software-architect/Yandex_Cloud_services_oct_23.xml?etag=2b1ed124cee4731d14f2691b9a187e45)) и контейнеров ([Yandex-Cloud-containers_oct_23.drawio.xml](https://code.s3.yandex.net/software-architect/Yandex-Cloud-containers_oct_23.drawio.xml?etag=1434877819f05ab6c6ff90662ca6a1a0)).
Установите инструменты, которые нужны для выполнения заданий:
Minikube.
Kubectl.
Python.
Pip
Locast. Чтобы его установить, потребуется pip.
...
Вот схема текущей архитектуры в draw.io (см. [тут](https://code.s3.yandex.net/software-architect/InsureTech_технологическая_архитектура-as-is.drawio.xml?etag=92b33e266cccdb03c526405d60095b02))
...
Проверьте, что метрики из вашего приложения поступают в Prometheus с помощью Prometheus Web UI: откройте раздел Graph или Targets и убедитесь, что метрики отображаются.  Сделайте скриншоты интерфейса с метриками и загрузите их в директорию Task2.
Настройте автоматическое масштабирование по RPS через HPA. Для этого создайте новую версию манифеста. Когда будете сдавать задание, загрузите его в директорию Task2.
...
Проанализируйте текущую архитектуру. Создайте текстовый документ и напишите там список проблем и рисков, которые связаны с планируемым ростом нагрузки. Когда всё будет готово, загрузите документ в директорию Task3 в рамках пул-реквеста.
